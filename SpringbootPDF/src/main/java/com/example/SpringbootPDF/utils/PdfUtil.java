...
/**
 * @ClassName PdfUtil
 * @Description //https://blog.csdn.net/java_t_t/article/details/129783126
 * @Author XuHaijwill
 * @Date 2024/8/18 17:49
 * @Version 1.0
 **/
public class PdfUtil {
    public static void main(String[] args) throws Exception {
        String pdfFile = "D:\\TEMP\\demo.pdf";
    ...
    private static void addImage(Document document) throws IOException {
        ...
        Image image = Image.getInstance("D:\\TEMP\\addImage.jpg");
        // 重设图片大小
